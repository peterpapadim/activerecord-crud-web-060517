...
def can_be_found_updated_and_saved
  ...
  result = Movie.find_by(title: "Awesome Flick")
  result.title = "Even Awesomer Flick"
  result.save
end
...
def can_update_using_update_method
  ...
  result = Movie.find_by(title: "Wat?")
  result.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  result = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  result.destroy
end
